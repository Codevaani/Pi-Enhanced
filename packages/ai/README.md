...
```bash
npm install @codevaani7838/pie-ai
```

TypeBox exports are re-exported from `@codevaani7838/pie-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@codevaani7838/pie-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@codevaani7838/pie-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@codevaani7838/pie-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@codevaani7838/pie-ai';
...
```typescript
import { getImageModel, generateImages } from '@codevaani7838/pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@codevaani7838/pie-ai';
...
```typescript
import { getModel, stream } from '@codevaani7838/pie-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@codevaani7838/pie-ai';
...
```typescript
import { Model, stream } from '@codevaani7838/pie-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@codevaani7838/pie-ai';
...
```typescript
import { getModel, complete, Context } from '@codevaani7838/pie-ai';
...
```typescript
import { Context, getModel, complete } from '@codevaani7838/pie-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@codevaani7838/pie-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@codevaani7838/pie-ai';
...
```bash
npx @codevaani7838/pie-ai login              # interactive provider selection
npx @codevaani7838/pie-ai login anthropic    # login to specific provider
npx @codevaani7838/pie-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@codevaani7838/pie-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@codevaani7838/pie-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@codevaani7838/pie-ai/oauth';
...
```typescript
import { getModel, complete } from '@codevaani7838/pie-ai';
import { getOAuthApiKey } from '@codevaani7838/pie-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@codevaani7838/pie-ai`
