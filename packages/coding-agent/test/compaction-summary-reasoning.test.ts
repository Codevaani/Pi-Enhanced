...
import type { AssistantMessage, Model } from "@codevaani7838/pie-ai";
...
vi.mock("@codevaani7838/pie-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@codevaani7838/pie-ai")>();
	return {
		...actual,
