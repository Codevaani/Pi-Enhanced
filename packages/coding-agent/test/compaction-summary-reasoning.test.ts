...
import type { AssistantMessage, Model } from "@earendil-works/pie-ai";
...
vi.mock("@earendil-works/pie-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@earendil-works/pie-ai")>();
	return {
		...actual,
