...
| Package | Purpose |
|---------|---------|
| `@codevaani7838/pie-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@codevaani7838/pie-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@codevaani7838/pie-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@codevaani7838/pie-coding-agent";
...
```typescript
import { isBashToolResult } from "@codevaani7838/pie-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@codevaani7838/pie-coding-agent";
...
```typescript
import { SessionManager } from "@codevaani7838/pie-coding-agent";
...
```typescript
import type { AutocompleteItem } from "@codevaani7838/pie-tui";
...
```typescript
import { withFileMutationQueue } from "@codevaani7838/pie-coding-agent";
...
**Important:** Use `StringEnum` from `@codevaani7838/pie-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@codevaani7838/pie-coding-agent";
...
```typescript
import { createBashTool } from "@codevaani7838/pie-coding-agent";
...
```typescript
import { keyHint } from "@codevaani7838/pie-coding-agent";
...
```typescript
import { Text, Component } from "@codevaani7838/pie-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@codevaani7838/pie-coding-agent";
import { matchesKey } from "@codevaani7838/pie-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@codevaani7838/pie-coding-agent";
