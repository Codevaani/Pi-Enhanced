...
Discovery rules:
- In `~/.pie/agent/skills/` and `.pie/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.pie/settings.json`:
...
- [Pi Skills](https://github.com/Codevaani/pi-skills) - Web search, browser automation, Google APIs, transcription
