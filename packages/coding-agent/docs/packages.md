...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@codevaani7838/pie-ai`, `@codevaani7838/pie-agent-core`, `@codevaani7838/pie-coding-agent`, `@codevaani7838/pie-tui`, `typebox`.
