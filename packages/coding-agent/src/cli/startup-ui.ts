import { ProcessTerminal, setKeybindings, TUI } from "@codevaani7838/pie-tui";
...
const OFFICIAL_PACKAGE_NAME = "@codevaani7838/pie-coding-agent";
 ...
 * - this is the official Pie distribution (not a fork/rebrand)
