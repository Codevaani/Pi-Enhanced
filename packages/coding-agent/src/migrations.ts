...
/**
 * Migrate sessions from ~/.pie/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.pie/agent/ instead of
 * ~/.pie/agent/sessions/<encoded-cwd>/. This migration moves them
