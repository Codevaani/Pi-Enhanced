...
function getPieDocsClassification(absolutePath: string): CompactReadClassification | undefined {
...
function getCompactReadClassification(
	...
	const docsClassification = getPieDocsClassification(absolutePath);
