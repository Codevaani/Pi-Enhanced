...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@earendil-works/pie-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@earendil-works/pie-coding-agent";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown pie and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what pie loaded without re-discovering resources. */
...
export interface ExtensionAPI {
	 ...
	 * pie.registerProvider("anthropic", {
	 *   baseUrl: "https://proxy.example.com"
	 * });
	 *
	 * @example
	 * // Register provider with OAuth support
	 * pie.registerProvider("corporate-ai", {
	 ...
	 *
	 * @example
	 * pie.unregisterProvider("my-proxy");
	 */
...
/** Configuration for registering a provider via pie.registerProvider(). */
...
export interface ProviderModelConfig {
	...
	reasoning: boolean;
	/** Maps pie thinking levels to provider/model-specific values; null marks a level unsupported. */
...
/**
 * Action implementations for pie.* API methods.
