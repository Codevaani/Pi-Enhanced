import { type AgentMessage, uuidv7 } from "@earendil-works/pie-agent-core";
 ...
 * Encodes cwd into a safe directory name under ~/.pie/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.pie/agent/sessions/<encoded-cwd>/).
	 */
