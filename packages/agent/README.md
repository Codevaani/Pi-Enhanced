# @codevaani7838/pie-agent-core

Stateful agent with tool execution and event streaming. Built on `@codevaani7838/pie-ai`.

## Installation

```bash
npm install @codevaani7838/pie-agent-core
```
...
```typescript
declare module "@codevaani7838/pie-agent-core" {
...
```typescript
import { Agent, streamProxy } from "@codevaani7838/pie-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@codevaani7838/pie-agent-core";
